...
export const heroSlides = [
  {
    ...
    accent: "Grow Faster.",
    subtext: "Access 20+ expert-led courses in technology, business, design and more. Transform your career with Gizami.",
    ctaPrimary: "Get Started Free",
    ctaSecondary: "Browse Courses",
    badge: "🎓 Trusted by 300+ learners worldwide",
    stat1: { value: "20+", label: "Courses" },
    stat2: { value: "300+", label: "Students" },
  ...
  },
  {
    ...
    stat1: { value: "10+", label: "Instructors" },
  ...
  },
  {
    ...
    badge: "✨ Recognized by 10+ top companies",
    stat1: { value: "4+", label: "Certifications" },
    stat2: { value: "10+", label: "Partners" },
